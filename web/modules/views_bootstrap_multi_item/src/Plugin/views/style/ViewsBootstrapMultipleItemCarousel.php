...
namespace Drupal\views_bootstrap_multi_item\Plugin\views\style;
 ...
 *
 * @ViewsStyle(
 *   id = "views_bootstrap_multi_item_carousel",
 *   title = @Translation("Bootstrap Multi Item Carousel"),
 *   help = @Translation("Displays rows in a Bootstrap Carousel with multiple active items."),
 *   theme = "views_bootstrap_multi_item",
 *   theme_file = "../views_bootstrap_multi_item.theme.inc",
 *   display_types = {"normal"}
 * )
 */
class ViewsBootstrapMultipleItemCarousel extends StylePluginBase {
  /**
